define(
    ...
    function ($) {
        $.widget(
            'riverstone.riverstone_beforebodyend',
            {
                _create: function () {
                            ...
                            $(document).on(
                                ...
                                function (e) {
                                    ...
                                    if ($(this).attr('data-post')) {
                                        ...
                                        url = data_url.action + 'product/' + data_url.data.product + '/qty/' + qty + '/form_key/' + from_key + '/uenc/' + data_url.data.uenc + '/riverstonequickview/1';
                                    } else {
                                        url = $(this).attr('href');
        ...
        return $.riverstone.riverstone_beforebodyend;
    });
